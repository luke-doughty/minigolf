...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/Small Trees.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Pine_Tree_02.geometry}
        material={materials['17___Default']}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Pine_Tree_01.geometry}
        material={materials['17___Default']}
      />
    </group>
  )
...
useGLTF.preload('/Small Trees.glb')
