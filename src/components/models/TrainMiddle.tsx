...
export function TrainMiddle(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/RailwayCarriage.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Railway_carriage_b.geometry}
...
useGLTF.preload('/Railway carriage.glb')
