...
import { Sphere, Tube, useGLTF } from '@react-three/drei'
...
export const FlagPost: FC<FlagPostProps> = ({ initialPos, ...props }) => {
  ...
  const holeOffsetFromPole = new Vector3(-0.09, 0.45, -0.04)
  const holePos = new Vector3().addVectors(initialPos, holeOffsetFromPole)
